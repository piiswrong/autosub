...
class Player(wx.Frame):
    ...
    def __init__(self, title):
        ...
        self.file_menu2=wx.Menu()
        self.file_menu2.Append(3,"&Show Subtitle Editor","SHow the Subtitle");
        self.file_menu2.Append(4,"&Subtitle Generator","Generate the Subtitle");

        self.Bind(wx.EVT_MENU, self.OnOpen, id=1)
        self.Bind(wx.EVT_MENU, self.OnExit, id=2)
        self.Bind(wx.EVT_MENU, self.ShowSubtitle,id=3)
        self.Bind(wx.EVT_MENU, self.Translate,id=4)

        self.frame_menubar.Append(self.file_menu, "File")
        self.frame_menubar.Append(self.file_menu2,"Subtitles")
    ...
    def Translate(self,evt):
        ...
        if(dlg.ShowModal()==wx.ID_OK):
            ...
            did=os.getcwd()
            os.system(did+'/Products/autosub.py'+' -r en -t zh-cn '+self.filename);
    ...
    def OnOpen(self, evt):
        ...
        if dlg.ShowModal() == wx.ID_OK:
            ...
            # ret=os.system('autosub.exe'+' -r en -t zh-cn '+filename);
            # print ret
            # print dirname;
            # Creation
            self.Media = self.Instance.media_new(unicode(os.path.join(self.dirname, self.filename)))
